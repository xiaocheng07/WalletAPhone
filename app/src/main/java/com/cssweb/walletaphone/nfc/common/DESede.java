...
//41424344454647488000000000000000
        byte[] data = {0x14, 0x01, 0x00, 0x33, 0x00, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, (byte)0x80, 0x00, 0x00};
        //System.out.println("测试工具用编码data=" + HEX.ByteArray ToHexString(data.getBytes()));// 输出结果输入测试工具
